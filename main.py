...
app = Flask(__name__)
app.config["SECRET_KEY"] = "JHSBFIHEFBD"
...
def home():
    ...
    if request.method == "POST":
        ...
        if not name:
            print(code)
            return render_template("home.html", error="Enter A Fucking Name", code=code, name=name)
        ...
        elif code == "" or code.isspace():
            return render_template("home.html", error="Room Needs A Code", code=code, name=name)
